// Movies page: product modal behavior (category5 grid).

const moviesModal = document.getElementById("productModal");
const moviesCloseBtn = document.querySelector(".close-btn");

if (moviesModal && moviesCloseBtn) {
  document
    .querySelectorAll(".masonry-item-category5 img")
    .forEach((img) => {
      img.addEventListener("click", function () {
        ...
        moviesModal.classList.add("active");
      });
    });

  moviesCloseBtn.addEventListener("click", () => {
    moviesModal.classList.remove("active");
  });
