// Pop page: product modal behavior (category3 grid).

const popModal = document.getElementById("productModal");
const popCloseBtn = document.querySelector(".close-btn");

if (popModal && popCloseBtn) {
  document
    .querySelectorAll(".masonry-item-category3 img")
    .forEach((img) => {
