// Series page: product modal behavior (category5 grid).

const seriesModal = document.getElementById("productModal");
const seriesCloseBtn = document.querySelector(".close-btn");

if (seriesModal && seriesCloseBtn) {
  document
  ...
  seriesCloseBtn.addEventListener("click", () => {
