// Music page: product modal behavior (category1 grid).

const musicModal = document.getElementById("productModal");
const musicCloseBtn = document.querySelector(".close-btn");

if (musicModal && musicCloseBtn) {
  document
    .querySelectorAll(".masonry-item-category1 img")
    .forEach((img) => {
